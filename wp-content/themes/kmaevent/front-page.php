...
get_header();
$first_day                        = get_field( 'first_day', 6 );
$second_day                       = get_field( 'second_day', 6 );
$first_day_adult_admission_price  = get_field( 'first_day_adult_admission_price', 6 );
$second_day_adult_admission_price = get_field( 'second_day_adult_admission_price', 6 );
$child_over_6_price               = get_field( 'child_over_6_price', 6 );
$child_under_6_price              = get_field( 'child_under_6_price', 6 );
$active_military_price            = get_field( 'active_military_price', 6 );
$parking_fee                      = get_field( 'parking_fee', 6 );
?>
    <div id="slider">
                ...
                <div class="row justify-content-center text-center">
                    <div class="col-md-5">
                        ...
                        <div class="fb-page d-block" data-href="https://www.facebook.com/FLAScallopFestival/"
                             data-tabs="timeline" data-width="500" data-height="679" data-small-header="true"
                             data-adapt-container-width="true" data-hide-cover="true" data-show-facepile="false">
                            <blockquote cite="https://www.facebook.com/FLAScallopFestival/"
                                        class="fb-xfbml-parse-ignore"><a
                                        href="https://www.facebook.com/FLAScallopFestival/">Florida Scallop &amp; Music
                                    Festival</a></blockquote>
                        </div>
                        <p class="hash"><a href="https://www.facebook.com/FLAScallopFestival/" target="_blank">#FLAScallopFestival</a>
                        </p>
                    </div>
